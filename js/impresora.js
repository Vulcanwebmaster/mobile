  ...
  for(var camp in vetor){
   ...
   for(var jg in jsonServidor.jogos){
    if(jsonServidor.jogos[jg].campeonato.descricao_campeonato==vetor[camp] && toData(jsonServidor.jogos[jg].data)==toData(vetorHora[datas])){
      ...
      window.DatecsPrinter.printText("{s}"+jsonServidor.jogos[jg].valor_casa+"   "+jsonServidor.jogos[jg].valor_empate+"   "+jsonServidor.jogos[jg].valor_fora+"   "+jsonServidor.jogos[jg].casa_1x0+"   "+jsonServidor.jogos[jg].valor_dupla+"   "+jsonServidor.jogos[jg].valor_1_2+"   "+jsonServidor.jogos[jg].min_gol_3+"   "+jsonServidor.jogos[jg].max_gol_2+"   "+jsonServidor.jogos[jg].ambas_gol+"{/s}{br}",'ISO-8859-1', function(){});
...
function printSomeTestText2() { 
  ...
  window.DatecsPrinter.printText("{br}{br}{br}{br}{br}{br}",'ISO-8859-1', function(){});
  Materialize.toast('Impresão Realizada com Sucesso!', 4000);
}
...
function printSomeTestText3() {
  ...
  window.DatecsPrinter.printText("* Ticket sera pago em ate 72 horas;{br}",'ISO-8859-1', function(){});
  window.DatecsPrinter.printText("* Se o jogo nao acontecer no prazo de 24 horas  da data e hora marcada ele sera retirado e as   apostas serao recalculadas.{br}",'ISO-8859-1', function(){});
  window.DatecsPrinter.printText("{b}** SEGUNDA VIA DO COMPROVANTE !; **{/b}{br}",'ISO-8859-1', function(){});
  window.DatecsPrinter.printText("{br}{br}{br}{br}{br}{br}",'ISO-8859-1', function(){});
