...
var tpapites = ["valor_casa", "valor_fora", "valor_empate", "valor_dupla", "casa_1x0", "casa_2x0", "casa_2x1", "casa_3x0", "casa_3x1", "casa_4x2", "casa_4x3", "casa_5x0", "casa_5x1", "casa_5x2", "fora_1x0", "fora_2x0", "fora_2x1", "fora_3x0", "fora_3x1", "fora_4x2", "fora_4x3", "fora_5x0", "fora_5x1", "fora_5x2", "valor_1_2", "max_gol_2", "min_gol_3", "ambas_gol"];
...
$scope.validar = function() {
  ...
  $http({
    url: 'http://179.189.250.189/aposta/validar',
    method: 'PUT',
    data: dadosAposta,
    headers: {
...
$scope.BuscarAposta = function() {
  $http.get('http://179.189.250.189/public/aposta/consultar/'+$scope.codAposta).then(function(response) {
    $scope.aux2=false;
    $scope.aux=true;
  ...
  for(var i in aptStatus.palpites){
    if(ob==aptStatus.palpites[i].jogos_id){
      ...
      if(aptStatus.palpites[i].tpalpite=="valor_casa"){
        ...
        x="Empate";
        return x;
      } else if(aptStatus.palpites[i].tpalpite=="casa_1x0"){
        x="Casa 1x0";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_2x0"){
        x="Casa 2x0";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_2x1"){
        x="Casa 2x1";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_3x0"){
        x="Casa 3x0";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_3x1"){
        x="Casa 3x1";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_4x2"){
        x="Casa 4x2";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_4x3"){
        x="Casa 4x3";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_5x0"){
        x="Casa 5x0";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_5x1"){
        x="Casa 5x1";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="casa_5x2"){
        x="Casa 5x2";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_1x0"){
        x="Fora 1x0";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_2x0"){
        x="Fora 2x0";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_2x1"){
        x="Fora 2x1";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_3x0"){
        x="Fora 3x0";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_3x1"){
        x="Fora 3x1";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_4x2"){
        x="Fora 4x2";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_4x3"){
        x="Fora 4x3";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_5x0"){
        x="Fora 5x0";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_5x1"){
        x="Fora 5x1";
        return x;
	  } else if(aptStatus.palpites[i].tpalpite=="fora_5x2"){
        x="Fora 5x2";
        return x;
...
$scope.acertar = function() {
  $http.get('http://179.189.250.189/public/cambista/acerto/'+$scope.codCambista+'/'+$scope.codAdm).then(function(response) {
    $scope.aux2=false;
    $scope.aux=true;
...
$scope.imprimirUltimaAposta = function() {
  $http.get('http://179.189.250.189/public/aposta/ultima/'+$scope.password).then(function(response) {
...
$scope.buscarDadosPorAposta = function() {
  $http.get('http://179.189.250.189/public/aposta/premiosApostas/'+$scope.password).then(function(response) {
...
app.controller('dadosCambista', function($scope, $http, $route, $location) { 
 ...
 $scope.buscarDadosCambista = function() {   
  $http.get('http://179.189.250.189/public/aposta/ganhosApostas/'+$scope.password).then(function(response) {
...
app.controller('controlCollapseible', function($scope, $http, $route, $location, $rootScope) {
  ...
  var allRadios = new Array();
    ...
    $scope.enviar = function() {
      ...
      $http({
        url: 'http://179.189.250.189/public/aposta/apostar',
        method: 'POST',
        data: json,
        headers: {
          'Accept': 'application/json',
    ...
    $scope.buscar = function() {
      $http.get('http://179.189.250.189/public/aposta').then(function(response) {
    ...
    $scope.nomePapites= function(np){
      ...
      if(nome_palpites[np]=="casa_1x0"){
        vetorPalpitesCorretos="Casa 1x0";
      } 
	  if(nome_palpites[np]=="casa_2x0"){
        vetorPalpitesCorretos="Casa 2x0";
      } 
	  if(nome_palpites[np]=="casa_2x1"){
        vetorPalpitesCorretos="Casa 2x1";
      } 
	  if(nome_palpites[np]=="casa_3x0"){
        vetorPalpitesCorretos="Casa 3x0";
      } 
	  if(nome_palpites[np]=="casa_3x1"){
        vetorPalpitesCorretos="Casa 3x1";
      } 
	  if(nome_palpites[np]=="casa_4x2"){
        vetorPalpitesCorretos="Casa 4x2";
      } 
	  if(nome_palpites[np]=="casa_4x3"){
        vetorPalpitesCorretos="Casa 4x3";
      } 
	  if(nome_palpites[np]=="casa_5x0"){
        vetorPalpitesCorretos="Casa 5x0";
      } 
	  if(nome_palpites[np]=="casa_5x1"){
        vetorPalpitesCorretos="Casa 5x1";
      } 
	  if(nome_palpites[np]=="casa_5x2"){
        vetorPalpitesCorretos="Casa 5x2";
      } 
	  if(nome_palpites[np]=="fora_1x0"){
        vetorPalpitesCorretos="Fora 1x0";
      } 
	  if(nome_palpites[np]=="fora_2x0"){
        vetorPalpitesCorretos="Fora 2x0";
      } 
	  if(nome_palpites[np]=="fora_2x1"){
        vetorPalpitesCorretos="Fora 2x1";
      } 
	  if(nome_palpites[np]=="fora_3x0"){
        vetorPalpitesCorretos="Fora 3x0";
      } 
	  if(nome_palpites[np]=="fora_3x1"){
        vetorPalpitesCorretos="Fora 3x1";
      } 
	  if(nome_palpites[np]=="fora_4x2"){
        vetorPalpitesCorretos="Fora 4x2";
      } 
	  if(nome_palpites[np]=="fora_4x3"){
        vetorPalpitesCorretos="Fora 4x3";
      } 
	  if(nome_palpites[np]=="fora_5x0"){
        vetorPalpitesCorretos="Fora 5x0";
      } 
	  if(nome_palpites[np]=="fora_5x1"){
        vetorPalpitesCorretos="Fora 5x1";
      } 
	  if(nome_palpites[np]=="fora_5x2"){
        vetorPalpitesCorretos="Fora 5x2";
      } 
